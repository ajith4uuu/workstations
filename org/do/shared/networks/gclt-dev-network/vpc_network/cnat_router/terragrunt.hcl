...
dependency "network" {
  ...
  mock_outputs = {
    vpc = {
      "network" = {
        "network_name" = "gclt-dev-network-vpc"
      }
    }
  }
}
...
inputs = {
  ...
  router_advertise_config = {
    ...
    mode   = "CUSTOM"
    ip_ranges = {
      "10.110.36.0/24" : "gclt-dev-network-eu-west1-1-pods"
      "10.110.37.0/24" : "gclt-dev-network-eu-west1-1-services"
      "10.110.44.0/23" : "gclt-dev-network-eu-west1-2-pods"
      "10.110.46.0/23" : "gclt-dev-network-eu-west1-2-services"
    }
  }
